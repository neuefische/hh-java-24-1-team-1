        ...
        <>
            ...
            <main>
                <Routes>
                    ...
                    <Route path={"/products/:id/edit"} element={<ProductUpdate availableStorageSpaces={getEmptyStorageSpaces().map((storageSpace:StorageSpace) => storageSpace.storageSpaceName)} updateProduct={updateProduct} getProductById={getProductById}/>}/>
